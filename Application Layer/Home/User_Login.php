...
<div class="form-group">
  ...
  <div class="card-body">
    ...
    <input type="password" class="form-control" placeholder="Enter Password" name="psw" id="pass"  required/>
...
<input type="button" name="register" class="btn btn-primary" value="register" style="width:130px" onclick="window.location.href='../Home/register.php'"></a></button>
