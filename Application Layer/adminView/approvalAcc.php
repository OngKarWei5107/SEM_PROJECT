...
$query = "select * from serviceProvider where approved='0'";
    ...
    <div class="well">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <center><h2>Account Approval</h2></center>
        </div>
      </div>
      <div class="well">
          ...
          ?>
            <tr>
              <td><?php echo $row['serviceProviderid']?></td>
              <td><?php echo $row['username']?></td>
              <td><?php echo $row['psw']?></td>
              <td><input type="checkbox" name="check[$i]" value="<?php echo $row['serviceProviderid']?>"> 
            </tr>
          <?php
          $i++;
          }
