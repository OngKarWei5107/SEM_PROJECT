...
<tr>
  <td><button class="w3-bar-item w3-button w3-green"><a href="foodAdd.php">ENTER</button></a></td>
  <td><button class="w3-bar-item w3-button w3-green"><a href="medicineAdd.php">ENTER</button></a></td>
  <td><button class="w3-bar-item w3-button w3-green"><a href="petItemAdd.php">ENTER</button></a></td>
</tr>
	</table>
</center>
<br><br>
