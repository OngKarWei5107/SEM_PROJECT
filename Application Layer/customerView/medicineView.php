  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="../customerView/medicineAdd.php">Add Cart</a></li>
...
<div class="w3-bar">
  <button class="w3-bar-item w3-button w3-green"><a href="medicineDesp.php?medicineid=<?php echo $medical['medicineid']?>">VIEW</button></a>
