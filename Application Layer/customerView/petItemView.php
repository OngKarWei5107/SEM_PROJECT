  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="../customerView/petItemAdd.php">Add Cart</a></li>
...
<div class="w3-bar">
  <button class="w3-bar-item w3-button w3-green"><a href="petDesp.php?petItemid=<?php echo $pet['petItemid']?>">VIEW</button></a>
