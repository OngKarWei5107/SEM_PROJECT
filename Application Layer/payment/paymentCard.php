        ...
        case "remove":
            ...
            if (!empty($_SESSION["cart_item"])) {
                foreach ($_SESSION["cart_item"] as $k => $v) {
                    if ($_GET["petItemName"] == $k){
                        unset($_SESSION["cart_item"][$k]);
                      }
                      else if($_GET["foodName"] == $k){
                        unset($_SESSION["cart_item"][$k]);
                      }
                      else if($_GET["medicineName"] == $k){
                        unset($_SESSION["cart_item"][$k]);
                      }
            ...
            else if (!empty($_SESSION["cart_item1"])) {
                foreach ($_SESSION["cart_item1"] as $k => $v) {
                    if ($_GET["petItemName"] == $k){
                        unset($_SESSION["cart_item"][$k]);
                      }
                      else if($_GET["foodName"] == $k){
                        unset($_SESSION["cart_item1"][$k]);
                      }
                      else if($_GET["medicineName"] == $k){
                        unset($_SESSION["cart_item1"][$k]);
                      }
            ...
            */
            ...
            header("location: ../payment/paymentCard.php");
            break;
    }
}
...
?>
                    ...
                    <tr>
                        <form action="../../Business Services layer/paymentController/charge.php" method="post">
...
else if(isset($_SESSION["cart_item1"])){
    $item_total = 0;
    ?>
          ...
          <div class="well">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <?php
                    $query3="SELECT MAX(order_id) from customer";
                    $res=mysqli_query($conn,$query3);
                    $row=mysqli_fetch_array($res);
                    $order_id=$row[0]+1; 
                    $count=1;
...
else if(isset($_SESSION["cart_item2"])){
    $item_total = 0;
    ?>
