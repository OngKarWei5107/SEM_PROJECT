<?php
require_once 'C:/xampp/htdocs/dms/Business Services Layer/deliveryController/deliveryController.php';
...
?>
  ...
  <td><input type="checkbox" name="check[$i]" value="<?php echo $row['id']?>"> 
  </tr>
  <?php
  $i++;
  }
