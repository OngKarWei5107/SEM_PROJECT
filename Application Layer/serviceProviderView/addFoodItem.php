...
<center>
<center><h2><font color="#0000A0">ADD food ITEM</font></h2></center>

  <table width="437" >
    <tr>
      <td width="92" ><b>Name:</b></td>
      <td width="254"><input name="foodName" type="text" id="Name" size="49" /></td>
    </tr>
    ...
    <br></br>
    <tr>
      <td colspan="2"><center><input type="submit" name="btnRegister" id="btnRegister" value="ADD food ITEM" /></center></td>
      </tr>
    <tr>
