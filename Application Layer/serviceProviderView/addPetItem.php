...
<center>
<center><h2><font color="#0000A0">ADD PET ITEM</font></h2></center>

  <table width="437" >
    <tr>
      <td width="92" ><b>Name:</b></td>
      <td width="254"><input name="petItemName" type="text" id="Name" size="49" /></td>
    </tr>

    <tr>
      <td ><b>Price:</b></td>
      <td><input name="price" type="number" id="Price" size="49" /></td>
    </tr>

    <tr>
      <td><b>Description:</b></td>
      <td ><textarea name="descp" id="Description" cols="50.9" rows="5"></textarea></td>
    </tr>

    <tr>
      <td><b>Quantity:</b></td>
      <td><input name="quantity" type="number" id="Quantity" size="49" /></td>
    </tr>
    ...
    <br></br>
    <tr>
      <td colspan="2"><center><input type="submit" name="btnRegister" id="btnRegister" value="ADD PET ITEM" /></center></td>
      </tr>
    <tr>
