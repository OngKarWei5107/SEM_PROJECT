...
$food = new foodController();
  ...
  $food->update($_POST['update']);
  }

  if (isset($_GET['foodid'])) {
  $food = $food->get($_GET['foodid']);
  }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href=" ../serviceProviderView/addFoodItem.php">Add Product</a></li>
        <li><a href="#">View</a></li>
...
<center>
<center><h2><font color="#0000A0">EDIT food ITEM</font></h2></center>
...
<td  align=center><td align=center></center>
  ...
  <table width="437" >
    <tr>
      ...
      <td width="254"><input name="foodName" type="text" id="Name" size="49" value="<?php echo $food['foodName'];?>"></td>
    </tr>

    <tr>
      <td ><b>Price:</b></td>
      <td><input name="price" type="number" id="Price" size="49" value="<?php echo $food['price'];?>"></td>
    </tr>

    <tr>
      <td><b>Description:</b></td>
      <td ><textarea name="descp" id="Description" cols="50.9" rows="5"><?php echo $food['descp']?></textarea></td>
    </tr>

    <tr>
      <td><b>Quantity:</b></td>
      <td><input name="quantity" type="number" id="Quantity" size="49" value="<?php echo $food['quantity'];?>"></td>
    </tr>

    <br>
    <tr>
    <div class="form-group">
                <input type="hidden" name="update" value="<?php echo $food['foodid']; ?>">
