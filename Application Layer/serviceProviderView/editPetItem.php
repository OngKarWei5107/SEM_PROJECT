...
$pet = new petItemController();
  ...
  $pet->update($_POST['update']);
  }

  if (isset($_GET['petItemid'])) {
  $pet = $pet->get($_GET['petItemid']);
  }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href=" ../serviceProviderView/addPetItem.php">Add Product</a></li>
        <li><a href="#">View</a></li>
...
<center>
<center><h2><font color="#0000A0">EDIT PET ITEM</font></h2></center>
...
<td  align=center><td align=center></center>
  ...
  <table width="437" >
    <tr>
      ...
      <td width="254"><input name="petItemName" type="text" id="Name" size="49" value="<?php echo $pet['petItemName'];?>"></td>
    </tr>

    <tr>
      <td ><b>Price:</b></td>
      <td><input name="price" type="number" id="Price" size="49" value="<?php echo $pet['price'];?>"></td>
    </tr>

    <tr>
      <td><b>Description:</b></td>
      <td ><textarea name="descp" id="Description" cols="50.9" rows="5"><?php echo $pet['descp']?></textarea></td>
    </tr>

    <tr>
      <td><b>Quantity:</b></td>
      <td><input name="quantity" type="number" id="Quantity" size="49" value="<?php echo $pet['quantity'];?>"></td>
    </tr>

    <br>
    <tr>
    <div class="form-group">
                <input type="hidden" name="update" value="<?php echo $pet['petItemid']; ?>">
