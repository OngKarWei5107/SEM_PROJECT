...
<div class="w3-bar">
  <button class="w3-bar-item w3-button w3-green"><a href="editFoodItem.php?foodid=<?php echo $food['foodid']?>">EDIT</button></a>

 <form method="POST" action="">
  <input type="hidden" name="delete" value="<?php echo $food['foodid'] ?>">
