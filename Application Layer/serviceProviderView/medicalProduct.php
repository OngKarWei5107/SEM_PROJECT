...
$medical = $controller->displayController();
...
<?php $count = 0;
  ...
  <td  align=center> <img src="../serviceProviderView/photo/<?=$medical['photo']?>" /></center>
	
 	<table>
         <tr>
         <td><strong><?php echo $medical['medicineName']; ?></strong></td></tr>
         <tr>
...
<div class="w3-bar">
  <button class="w3-bar-item w3-button w3-green"><a href="editMedicalItem.php?medicineid=<?php echo $medical['medicineid']?>">EDIT</button></a>

 <form method="POST" action="">
  <input type="hidden" name="delete" value="<?php echo $medical['medicineid'] ?>">
