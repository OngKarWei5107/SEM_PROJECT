...
$pet = $controller->displayController();
...
<?php $count = 0;
  ...
  <td  align=center> <img src="../serviceProviderView/photo/<?=$pet['photo']?>" /></center>
	
 	<table>
         <tr>
         <td><strong><?php echo $pet['petItemName']; ?></strong></td></tr>
         <tr>
...
<div class="w3-bar">
  <button class="w3-bar-item w3-button w3-green"><a href="editPetItem.php?petItemid=<?php echo $pet['petItemid']?>">EDIT</button></a>

 <form method="POST" action="">
  <input type="hidden" name="delete" value="<?php echo $pet['petItemid'] ?>">
  <button type="submit" class="w3-bar-item w3-button w3-red" onclick="return confirm('Are you sure you want to delete?')">DELETE</button>
</form>
</div>
